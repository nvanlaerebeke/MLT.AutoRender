...
namespace AutoRender.Lib.Melt {
    internal class MeltJob : CrazyUtils.Base {
        ...
        internal MeltJob(Project pProject) {
            Project = pProject;
        }
        ...
        public override int GetHashCode() {
            return this.GetHashCodeFromFields(this.Percentage, this.Project, this.Status, this.TimeTaken);
        }
