...
namespace CrazyUtils {
    public static class ConfigManager {
        ...
        private static List<KeyData> GetValueFromConfig(string pSection, string pParam, Type pType) {
        ...
        private static void WriteValueToConfig<T>(string pSection, List<KeyData> pValues) {
        ...
        public static T Get<T>(string pSection, string pParam, T pDefault, List<string> pComments) {
        ...
        public static T Get<T>(string pSection, string pParam, T pDefault, string pComment) {
            return Get<T>(pSection, pParam, pDefault, new List<string> { pComment });
        }
        public static T Get<T>(string pSection, string pParam, T pDefault) {
            return Get<T>(pSection, pParam, pDefault, "");
        }
        public static T Get<T>(string pSection, T pDefault)  {
